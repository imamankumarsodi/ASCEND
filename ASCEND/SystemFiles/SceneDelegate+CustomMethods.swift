...
extension SceneDelegate:UNUserNotificationCenterDelegate{
    ...
    private func registerForRemoteNotification() {
        ...
        let simulaterToken = ConstantTexts.simulatorToken
        userDefaultApp.set(simulaterToken as String, forKey: ConstantTexts.deviceToken)
...
extension SceneDelegate:MessagingDelegate{
    ...
    func messaging(_ messaging: Messaging, didReceiveRegistrationToken fcmToken: String?) {
        ...
        if let getFCMToken = fcmToken{
            userDefaultApp.set(getFCMToken, forKey: ConstantTexts.deviceToken)
        }
    }
