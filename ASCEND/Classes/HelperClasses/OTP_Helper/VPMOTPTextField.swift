...
class VPMOTPTextField: UITextField {
    ...
    var borderColorN: UIColor = UIColor.black
    
    /// Border width info for field
    var borderWidthN: CGFloat = 2
    ...
    func initalizeUI(forFieldType type: VPMOTPView.DisplayType) {
        ...
        if type != .diamond && type != .underlinedBottom {
            layer.borderColor = borderColorN.cgColor
            layer.borderWidth = borderWidthN
        }
    ...
    fileprivate func addDiamondMask() {
        ...
        shapeLayer.lineWidth = borderWidthN
        shapeLayer.fillColor = backgroundColor?.cgColor
        shapeLayer.strokeColor = borderColorN.cgColor
