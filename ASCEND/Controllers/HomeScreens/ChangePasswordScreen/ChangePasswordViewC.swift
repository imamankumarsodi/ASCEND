...
class ChangePasswordViewC: SBaseViewController {
    //MARK: - IBOutlets
    
    @IBOutlet weak var txtCurrentPassword: UITextField!
    @IBOutlet weak var btnCurrentPasswordRef: UIButton!
    ...
    @IBAction func btnCurrentPassWordEyeTapped(_ sender: UIButton) {
        self.txtCurrentPassword.isSecureTextEntry = !self.txtCurrentPassword.isSecureTextEntry
        let image = self.txtCurrentPassword.isSecureTextEntry ? #imageLiteral(resourceName: "eye_open") : #imageLiteral(resourceName: "eye_close")
        self.btnCurrentPasswordRef.setImage(image, for: .normal)
