//
//  MyConnectionRootViewC+ScrollView.swift
//  ASCEND
//
...
extension MyConnectionRootViewC{
    ...
    internal func loadScrollViewWithcontroller() {
        ...
        let socialCircleVC = self.storyboard?.instantiateViewController(withIdentifier: SocialCircleViewC.className) as! SocialCircleViewC
        
        let followerVC = self.storyboard?.instantiateViewController(withIdentifier: FollowerFollowingViewC.className) as! FollowerFollowingViewC
        
        
       
        
        self.addChild(socialCircleVC)
        self.addChild(followerVC)
        self.loadScrollView()
    }
