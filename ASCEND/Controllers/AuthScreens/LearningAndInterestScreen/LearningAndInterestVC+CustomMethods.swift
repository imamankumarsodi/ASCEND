//
//  LearningAndInterestVC+CustomMethods.swift
//  ASCEND
//
...
extension LearningAndInterestVC{
    
    //TODO: Navigation setup implenemtation
    internal func navSetup(){
        super.isHiddenNavigationBar(false)
        super.setupNavigationBarTitle(AppColor.appColor, ConstantTexts.LearningAndInHT, leftBarButtonsType: [.back], rightBarButtonsType: [.empty])
    }
