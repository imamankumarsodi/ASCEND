...
class TeachingAndTalentViewC: SBaseViewController {
        ...
        UIView.animate(withDuration: 0.1,
                       ...
                       completion: { _ in
                        UIView.animate(withDuration: 0.1) {
                            ...
                            guard let vc = AppStoryboard.authSB.instantiateViewController(withIdentifier: TeachingAndTalentFullListVC.className) as? TeachingAndTalentFullListVC else{
                                 print("No TeachingAndTalentFullListVC found...")
                                 return
                             }
