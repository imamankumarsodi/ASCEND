                        ...
                        UIView.animate(withDuration: 0.1) {
                            ...
                            self.validateFields { (strMsg, status, anchorView) in
                                ...
                                if !status{
                                    ...
                                    let vc = AppStoryboard.authSB.instantiateViewController(withIdentifier: UserNameAndPasswordVC.className) as? UserNameAndPasswordVC
                                    
                                    guard let vcS = vc as? UserNameAndPasswordVC else{
