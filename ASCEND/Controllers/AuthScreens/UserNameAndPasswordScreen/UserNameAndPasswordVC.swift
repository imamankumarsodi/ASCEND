...
class UserNameAndPasswordVC: SBaseViewController {
    //MARK: - IBOutlets
                        ...
                        UIView.animate(withDuration: 0.1) {
                            ...
                            self.validateFields { (strMsg, status, anchorView) in
                                ...
                                if !status{
                                    ...
                                    let vc = AppStoryboard.authSB.instantiateViewController(withIdentifier: ConnectOtherAppVC.className) as? ConnectOtherAppVC
                                    
                                    guard let vcP = vc else{
                                        print("No ConnectOtherAppVC...")
                                        return
                                    }
